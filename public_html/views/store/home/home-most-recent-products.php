<?php
   ...
   * File description:    Contains the template most recent products module.
  ...
  $recentProductsList = $productObject->getRecentProductsList ();

?>

<!-- Products Start -->
<div class="container-fluid pt-5 pb-3">
  <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Lo más reciente</span>
  </h2>
