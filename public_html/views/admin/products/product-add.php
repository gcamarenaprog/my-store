<?php
   ...
   * Version:             1.0.0
   * File type:           View file
   * File description:    This file show the add new product screen.
   * Module:              Views
   * -------------------------------------------------------------------------------------------------------------------
   */
                      ...
                      <section>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control"
                                    ...
                                    required
                                    rows="7"
                                    placeholder="Especificaciones del producto"></textarea>
                          </div>
...
<!-- Custom view JS Code /-->
<script src="public_html/js/admin/js-product-add.js"></script>
