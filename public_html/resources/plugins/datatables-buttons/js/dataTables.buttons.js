...
// Allow for jQuery slim
  ...
  var Buttons = function (dt, config) {
    ...
    // For easy settings of buttons an array can be given
...
*/
    ...
    /**
     * Add a new button
     * @param {object} config Button settings object, base string name or function
...
*/
     ...
     * @param {object} conf Resolved button settings object
     * @private
     */
    ...
    _expandButton: function (attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
      ...
      for (var i = 0, ien = buttons.length; i < ien; i++) {
        ...
        // If the settings is an array, then expand the buttons at this
        // point
     ...
     * @param  {object} config            Resolved button settings
     ...
     * button is removed)
     * @param  {object} conf Button settings
     * @private
     */
    ...
    _resolveExtends: function (conf) {
      ...
      var toConfObject = function (base) {
        ...
        // Loop until we have resolved to a button settings, or an
...
// types (DRY)
   ...
   *
   * @param {object}    config Button settings
